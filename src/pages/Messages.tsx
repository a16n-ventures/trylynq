...
export default function Messages() {
  ...
  return (
    <div className="container-mobile pt-6 min-h-screen flex flex-col pb-20 bg-background">
      ...
      {!user && (
        <div className="px-1 mb-4 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
          <p className="text-sm text-yellow-600 dark:text-yellow-500">⚠️ User not authenticated</p>
        </div>
      )}
