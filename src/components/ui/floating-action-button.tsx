...
export const FloatingActionButton = ({ onClick, className, label = 'Create Event' }: FloatingActionButtonProps) => {
  return (
    <Button
      onClick={onClick}
      className={cn(
        "fixed bottom-20 right-4 mb-6 sm:right-6 z-40 h-12 w-12 sm:h-14 sm:w-14 rounded-full shadow-glow gradient-primary text-white hover:shadow-primary transition-smooth",
